...
page = st.sidebar.radio("Select a Page:", ["Pipeline Creator", "Execution Logs", "Pipeline Metrics", "Query Data"])
...
elif page == "Query Snowflake Data":
    from src.streamlit_app.page_modules.query_data import query_data_page
